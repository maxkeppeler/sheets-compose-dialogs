...
public val EmojiEmotions: ImageVector
    get() {
        if (_sharpEmojiEmotions != null) {
            return _sharpEmojiEmotions!!
        }
        _sharpEmojiEmotions = materialIcon(name = "Rounded.EmojiEmotions") {
            materialPath {
                moveTo(11.99f, 2.0f)
...
private var _sharpEmojiEmotions: ImageVector? = null
