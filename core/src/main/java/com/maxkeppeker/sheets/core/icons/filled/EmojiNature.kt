...
public val EmojiNature: ImageVector
    get() {
        if (_filledEmojiNature != null) {
            return _filledEmojiNature!!
        }
        _filledEmojiNature = materialIcon(name = "Filled.EmojiNature") {
            materialPath {
                moveTo(21.94f, 4.88f)
...
private var _filledEmojiNature: ImageVector? = null
