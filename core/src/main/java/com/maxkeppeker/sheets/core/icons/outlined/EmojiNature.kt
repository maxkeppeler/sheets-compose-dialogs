...
public val EmojiNature: ImageVector
    get() {
        if (_outlinedEmojiNature != null) {
            return _outlinedEmojiNature!!
        }
        _outlinedEmojiNature = materialIcon(name = "Outlined.EmojiNature") {
            materialPath {
                moveTo(21.94f, 4.88f)
...
private var _outlinedEmojiNature: ImageVector? = null
