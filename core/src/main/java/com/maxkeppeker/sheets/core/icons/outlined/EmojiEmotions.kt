...
public val EmojiEmotions: ImageVector
    get() {
        if (_outlinedEmojiEmotions != null) {
            return _outlinedEmojiEmotions!!
        }
        _outlinedEmojiEmotions = materialIcon(name = "Sharp.EmojiEmotions") {
            materialPath {
                moveTo(11.99f, 2.0f)
...
private var _outlinedEmojiEmotions: ImageVector? = null
