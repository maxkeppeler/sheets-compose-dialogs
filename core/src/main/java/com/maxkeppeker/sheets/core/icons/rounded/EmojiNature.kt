...
public val EmojiNature: ImageVector
    get() {
        if (_roundedEmojiNature != null) {
            return _roundedEmojiNature!!
        }
        _roundedEmojiNature = materialIcon(name = "Rounded.EmojiNature") {
            materialPath {
                moveTo(21.94f, 4.88f)
            ...
            materialPath {
                ...
                curveToRelative(-0.19f, -0.54f, -0.49f, -1.05f, -0.93f, -1.49f)
                reflectiveCurveTo(12.54f, 9.78f, 12.0f, 9.59f)
                verticalLineTo(8.5f)
                curveTo(12.0f, 8.22f, 11.78f, 8.0f, 11.5f, 8.0f)
                reflectiveCurveTo(11.0f, 8.22f, 11.0f, 8.5f)
                ...
                curveTo(16.0f, 12.22f, 15.78f, 12.0f, 15.5f, 12.0f)
                close()
                moveTo(4.67f, 14.29f)
...
private var _roundedEmojiNature: ImageVector? = null
